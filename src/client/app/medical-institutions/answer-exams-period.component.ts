...
@Component( {
               moduleId: module.id,
               selector: 'answer-exams-period',
               templateUrl: 'answer-exams-period.component.html',
               providers: [ ConfirmationService ]
            } )
export class AnswerExamsPeriodComponent implements OnInit {
   ...
   ngOnInit() {
      this.documentManagementService.getAll().subscribe( data => {
         this.idCertificado = data.find( d => d.codigoInstitucional === 'GTHFO04' ).idAdjunto; // adjunto formato de examen medico
