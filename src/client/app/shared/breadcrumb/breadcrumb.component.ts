...
export class BreadcrumbComponent implements OnInit, OnChanges, OnDestroy {
   ...
   setAllFriendlyName() {
      ...
      this.breadcrumbService.hideRoute( '/employees/supplies-confirmation' );
      this.breadcrumbService.addFriendlyNameForRouteRegex( '^/employees/supplies-confirmation/[0-9]*$', 'Confirmar Dotación' );
      ...
      this.breadcrumbService.addFriendlyNameForRoute( '/supplies', 'Dotaciones' );
      this.breadcrumbService.addFriendlyNameForRoute( '/supplies/add', 'Nuevo' );
      this.breadcrumbService.addFriendlyNameForRoute( '/supplies/update', 'Actualizar' );
      ...
      this.breadcrumbService.addFriendlyNameForRoute( '/eventualities/update', 'Actualizar' );
      this.breadcrumbService.addFriendlyNameForRoute( '/eventualities/detail', 'Detalle' );
      this.breadcrumbService.hideRouteRegex( '^/eventualities/update/[0-9]*' );
      this.breadcrumbService.hideRouteRegex( '^/eventualities/detail/[0-9]*' );
      ...
      this.breadcrumbService.addFriendlyNameForRoute( '/supplies-projection/assignations', 'Lista de dotaciones por asignar' );
      this.breadcrumbService.addFriendlyNameForRoute( '/supplies-projection/assignations/assign', 'Asignar/Entregar Dotaciones' );
      this.breadcrumbService.addFriendlyNameForRoute( '/supplies-projection/assignations/detail', 'Detalle de la asignación' );
      this.breadcrumbService.hideRouteRegex( '^/supplies-projection/assignations/[0-9]');
      this.breadcrumbService.hideRouteRegex( '^/supplies-projection/assignations/assign/[0-9]*');
      this.breadcrumbService.hideRouteRegex( '^/supplies-projection/assignations/detail/[0-9]*');

      this.breadcrumbService.addFriendlyNameForRoute( '/tracing-supplies', 'Seguimiento a Dotaciones' );

      this.breadcrumbService.addFriendlyNameForRoute( '/accidents-incidents', 'Accidentes e Incidentes' );
      this.breadcrumbService.addFriendlyNameForRoute( '/accidents-incidents/plan', 'Plan de Acción' );
      this.breadcrumbService.hideRouteRegex( '^/accidents-incidents/plan/[0-9]*' );

      this.breadcrumbService.addFriendlyNameForRoute( '/job-adaptation', 'Adaptación Laboral' );
      this.breadcrumbService.addFriendlyNameForRoute( '/job-adaptation/exam', 'Programar Examen' );
      this.breadcrumbService.hideRouteRegex( '^/accidents-incidents/exam/[0-9]*' );
   }
}
