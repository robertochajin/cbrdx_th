...
export class OcupacionesComponent implements OnInit {
   ...
   validateCode() {
      this.codeExists = this.listadoOcupaciones.filter(
            t => (t.codigoOcupacion === this.ocupaciones.codigoOcupacion && this.ocupaciones.idOcupacion !== t.idOcupacion) ).length > 0;
   }
