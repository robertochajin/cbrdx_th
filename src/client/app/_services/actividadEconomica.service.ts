...
export class ActividadEconomicaService {
    ...
    addActividadEconomica(c: ActividadEconomica): Promise<ActividadEconomica> {
        return this.http.post(this.serviceURL, JSON.stringify(c), {headers: this.headers})
    ...
    listActividadEconomicaTipos() {
        return this.http.get(this.serviceTiposURL,{headers: this.headers}).map((res: Response) => res.json() as ActividadEconomicaTipos[]);
    }
    ...
    listByPadre(id: number) {
      return this.http.get(this.serviceURL+'padre/'+ id+'/',{headers: this.headers})
         .map((res: Response) => res.json() as ActividadEconomica[]);
    }
    listLastChild(id: number) {
      return this.http.get(this.serviceURL+'lastChild/'+ id+'/',{headers: this.headers})
         .map((res: Response) => res.json() as ActividadEconomica[]);
    }
}
