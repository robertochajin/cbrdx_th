...
export class FormManagerService {
   ...
   getAllFunctionalityControl() {
      return this.authHttp.get( this.serviceURL + 'funcionalidadesControles' ).map( ( res: Response ) => res.json() as FunctionalityControl[] );
   }
   ...
   getSectionByIdFuncionalidad( id: number ) {
      return this.authHttp.get( this.serviceURL + 'funcionalidadesControles/secycam/' + id + '/true' ).map( ( res: Response ) => res.json() );
   }
   
   getFieldByIdFuncionalidad( id: number ) {
      return this.authHttp.get( this.serviceURL + 'funcionalidadesControles/secycam/' + id + '/false' ).map( ( res: Response ) => res.json() );
   }
   ...
   getFuncionalidadesControlesEnabled() {
      return this.authHttp.get( this.serviceURL + 'funcionalidadesControles/enabled' ).map( ( res: Response ) => res.json() as FunctionalityControl[] );
   }
